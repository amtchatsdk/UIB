...
public class FileUtils {
     ...
     */
    @NonNull
    public static String getExtension(@NonNull String uri) {
        if (uri == null) {
            return null;
        }
     ...
     * @author paulburke
     */
    public static boolean isMediaUri(@NonNull Uri uri) {
    ...
    public static String getPath(final @NonNull Context context, final @NonNull Uri uri) {
        ...
        // DocumentProvider
        if (DocumentsContract.isDocumentUri(context, uri)) {// LocalStorageProvider
     ...
     */
    @NonNull
    public static Bitmap getThumbnail(@NonNull Context context, @NonNull Uri uri, @NonNull String mimeType) {
        if (DEBUG)
